...
var _tint_alpha   = 0.24;   // lighter tint for a more natural dusk tone
...
with (o_eff_lighting_controller) {
    ...
    lighting_darken   = 0.6;                         // softer darkening for natural ambience
    ...
    animate(0, 0.5, 180, anime_curve.linear, id, "lighting_alpha");
}
// ── Spawn fireflies ───────────────────────────────────────────────
var _firefly_count = 30;
...
for (var _i = 0; _i < array_length(global.party_names); _i++) {
    ...
    var _target_blend = merge_color(c_white, _twilight_col, _tint_alpha);
    animate(_inst.image_blend, _target_blend, 180, anime_curve.linear, _inst, "image_blend");
}
