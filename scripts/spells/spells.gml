function item_s_thunderzap() : item_spell() constructor {
    name = [loc("spell_thunder_zap_name")]
    desc = loc("spell_thunder_zap_desc")
    ...
    use = function(spell_user, target, caller = -1, _name) {
		...
		cutscene_dialogue(string(loc("spell_cast"), party_getname(spell_user), string_upper(loc("spell_thunder_zap_name"))),, false)
...
function item_s_highguard() : item_spell() constructor {
    name = [loc("spell_highguard_name")]
    desc = [loc("spell_highguard_desc")]
 ...
 cutscene_dialogue(string(loc("spell_cast"), party_getname(spell_user), string_upper(loc("spell_highguard_name"))),, false)
